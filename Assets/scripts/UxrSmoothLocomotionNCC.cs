...
namespace UltimateXR.Locomotion
{
    ...
    /// </summary>
    public class UxrSmoothLocomotionNCC : UxrLocomotion
    {
        ...
        [SerializeField] private float _rotationDegreesNormal = 45.0f;
        ...
        private bool _joystickPreviouslyPressed;
        ...
        /// </summary>
        public float RotationDegreesNormal
        {
            get => _rotationDegreesNormal;
            set => _rotationDegreesNormal = value;
        }
        ...
        protected override void UpdateLocomotion()
        {
            if (Avatar)
            {
                ...
                bool joystickPressed = !Mathf.Approximately(joystickRight.x, 0.0f);

                if (joystickPressed && !_joystickPreviouslyPressed)
                {
                    float rotationDegrees = _rotationDegreesNormal;
                    UxrManager.Instance.RotateAvatar(Avatar, Mathf.Sign(joystickRight.x) * rotationDegrees);
                }

                _joystickPreviouslyPressed = joystickPressed;
